...
{
    font.loadFromFile("Textures/Roboto-Bold.ttf");
    // Inside the Game::Game constructor
    infoLogin.setOutlineThickness(-5.f);
    infoLogin.setFillColor(sf::Color::Black);
    infoLogin.setOutlineColor(sf::Color::Black);
    infoLogin.setPosition(sf::Vector2f(850.f, 200.f));  // Adjust position
    infoLogin.setSize(sf::Vector2f(180.f, 80.f));
    textLogin.setFont(font);
    textLogin.setString("Login");
    textLogin.setCharacterSize(25);
    textLogin.setFillColor(sf::Color::Green);
    textLogin.setPosition(infoLogin.getPosition().x + 50.f, infoLogin.getPosition().y + 13.f);
    infoRegister.setFillColor(sf::Color::Black);
    infoRegister.setOutlineThickness(-5.f);
    infoRegister.setOutlineColor(sf::Color::Black);
    infoRegister.setPosition(sf::Vector2f(850.f, 250.f));  // Adjust position
    infoRegister.setSize(sf::Vector2f(180.f, 80.f));
    textRegister.setFont(font);
    textRegister.setString("Register");
    textRegister.setCharacterSize(25);
    textRegister.setFillColor(sf::Color::Green);
    textRegister.setPosition(infoRegister.getPosition().x + 35.f, infoRegister.getPosition().y + 13.f);  //end here



    infoRestart.setFillColor(sf::Color::Black);
    ...
    infoRestart.setSize(sf::Vector2f(180.f, 80.f));
    textRestart.setFont(font);
    textRestart.setString("Start Again");
    textRestart.setCharacterSize(25);
    textRestart.setFillColor(sf::Color::Blue);
    textRestart.setPosition(infoRestart.getPosition().x + 40.f, infoRestart.getPosition().y + 13.f);
    turn.setFont(font);
    ...
    chance.setFillColor(sf::Color::Green);
    ...
    situation.setFillColor(sf::Color::Green);
...
void Game::Start(sf::Color c1, sf::Color c2)   //pieces position on board
{
    number_of_moves = 0;
    isOver = false;
...
void Game::draw(sf::RenderTarget &target, sf::RenderStates states) const
{
    ...
    target.draw(infoLogin, states);
    target.draw(textLogin, states);
    target.draw(infoRegister, states);
    target.draw(textRegister, states);
    target.draw(infoRestart, states);
    target.draw(textRestart, states);
    if(isOver == false)
        target.draw(chance);
...
bool Game::SelectPiece(Square Cells[][8], int x, int y)
{
    ...
    selected = true;
    if (Cells[x][y].occupied_color == 1) //select pieces
    {
